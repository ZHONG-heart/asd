<template>
  <div id="picture">
   <div class="main-container" v-loading="mainLoading"><!--v-loading="mainLoading"-->
      ...
      <el-row v-for="(item, index) in list" :key="index" v-loading="listLoading" style="margin:12px">
        <el-row class="detail-box" :style="{ backgroundColor: item.bgcolor}" style="height:380px;">
          <el-col :span="20" style="margin:4px">
            ...
            <el-row>
              <el-row style="border: 1px solid #d3dce6;background: #f3f3f3;height:240px;width:99%;overflow:auto;margin-top:5px;position:absolute;">
               <!-- 图片文字效果 -->
                <div style="display:flex;flex-wrap:wrap;">
                  <div class="box-card" v-for="(pic,picIndex) in item.content" >     <!--   :class="'bg'+pic.code" -->
                      <div>
                         <img :src="`${pic.url}`" alt="" @click="show(pic.url)" class="loadImg" style="z-index:99">
                         <img v-if="Imgload" src="https://zhong-heart.github.io/asd/erling/loading.gif" style="position:absolute;left:0;top:0;width:100%;height:100%;z-index:1;">
                          <!-- <p v-if="!Imgload" style="text-align:center;padding:30% 0;color:#FF4500#;">图片已删除</p> -->
                          <img v-if="!Imgload" src="https://zhong-heart.github.io/asd/erling/delate.png" alt="" style="left:25%;top:0;width:50%;height:50%;display:block;margin:20% auto;">
                      </div>
                      <p>{{pic.detail}}</p>
                   </div>
                </div>
            ...
            <el-row style="margin-top:255px">
              ...
              <el-col :span="8" style="display: flex;align-items: center;margin-bottom:5px">
    ...
    <div v-if="showHidden" id="show" style="width:100%;height:100%;position:fixed;left:0;top:0;z-index:999999;" @click="imghidden">
      <div style="width:35%;height:75%;margin:7% auto;overflow:auto;">
        <img :src="picUrl" style="width:100%;display:block;margin: auto;box-shadow:1px 2px 1px #ababca ;">
      </div>
...
// import { getContentList, submitAllList, submitOneOperation, getBanurl, getPictureList } from '@/api/content';
import { submitAllList, submitOneOperation, getBanurl, getPictureList } from '@/api/picture';
...
export default {
  name: 'picture',
  components: { Sticky, BackToTop, swiper, swiperSlide },
  directives: {
    waves,
    clipboard
  },
  data() {
    return {
      ...
      picUrl: 'https://zhong-heart.github.io/asd/erling/loading.gif',
      showHidden: false,
      Imgload: true
    };
  },
  ...
  methods: {
    getList() {
      ...
      getPictureList(this.listQuery, this.state).then(response => {
    ...
    imghidden() {
      ...
      this.picUrl = 'https://zhong-heart.github.io/asd/erling/loading.gif'
    }
...
.box-card div{
  ...
  // background: url(https://zhong-heart.github.io/asd/erling/loading.gif) center/cover;
  position: relative;
...
.bg1{
  ...
  box-shadow: 1px 2px 1px 1px red;
}
</style>